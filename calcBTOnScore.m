...
s=(tbl_result_regular.HomeScore+1) ...
    ./(tbl_result_regular.HomeScore+tbl_result_regular.AwayScore+2);  %修正得失点比
y=log(s./(1-s));  %logit
...
r=exp(inv(M)*p); %レーティングの計算

tbl_ranking=tbl_teams;
tbl_ranking.BTOnScore=r;

save rankByBTOnScore
